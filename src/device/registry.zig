...
pub const RegistryDevice = union(enum) {
    /// A unique identifier representing the device
    id: types.StringAttribute,
    /// The name of the device manufacturer
    manufacturer: types.StringAttribute,
    /// The model identifier for the device
    modelIdentifier: types.StringAttribute,
    /// The marketing name for the device model
    modelName: types.StringAttribute,
    ...
    pub fn get(self: @This()) types.AttributeInfo {
        return switch (self) {
            ...
            .manufacturer => types.AttributeInfo{
            ...
            .modelIdentifier => types.AttributeInfo{
