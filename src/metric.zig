...
/// | `error.type` | `Required` |
pub const ASPNETCORE_DIAGNOSTICS_EXCEPTIONS: []const u8 = "aspnetcore.diagnostics.exceptions";
...
pub const ASPNETCORE_RATE_LIMITING_ACTIVE_REQUEST_LEASES: []const u8 = "aspnetcore.rate_limiting.active_request_leases";
...
/// |:-|:- |
/// | `aspnetcore.rate_limiting.policy` | `Conditionally_required`: if the matched endpoint for the request had a rate-limiting policy. |
pub const ASPNETCORE_RATE_LIMITING_QUEUED_REQUESTS: []const u8 = "aspnetcore.rate_limiting.queued_requests";
...
pub const ASPNETCORE_RATE_LIMITING_REQUEST_TIME_IN_QUEUE: []const u8 = "aspnetcore.rate_limiting.request.time_in_queue";
...
/// |:-|:- |
/// | `aspnetcore.rate_limiting.policy` | `Conditionally_required`: if the matched endpoint for the request had a rate-limiting policy. |
pub const ASPNETCORE_RATE_LIMITING_REQUEST_LEASE_DURATION: []const u8 = "aspnetcore.rate_limiting.request_lease.duration";
...
/// | `aspnetcore.rate_limiting.policy` | `Conditionally_required`: if the matched endpoint for the request had a rate-limiting policy. |
/// | `aspnetcore.rate_limiting.result` | `Required` |
pub const ASPNETCORE_RATE_LIMITING_REQUESTS: []const u8 = "aspnetcore.rate_limiting.requests";
...
pub const ASPNETCORE_ROUTING_MATCH_ATTEMPTS: []const u8 = "aspnetcore.routing.match_attempts";
...
pub const AZURE_COSMOSDB_CLIENT_ACTIVE_INSTANCE_COUNT: []const u8 = "azure.cosmosdb.client.active_instance.count";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If using a port other than the default port for this DBMS and if `server.address` is set. |
pub const AZURE_COSMOSDB_CLIENT_OPERATION_REQUEST_CHARGE: []const u8 = "azure.cosmosdb.client.operation.request_charge";
...
pub const CICD_PIPELINE_RUN_ACTIVE: []const u8 = "cicd.pipeline.run.active";
...
pub const CICD_PIPELINE_RUN_DURATION: []const u8 = "cicd.pipeline.run.duration";
...
/// | `cicd.pipeline.name` | `Required` |
/// | `error.type` | `Required` |
pub const CICD_PIPELINE_RUN_ERRORS: []const u8 = "cicd.pipeline.run.errors";
...
/// | `error.type` | `Required` |
pub const CICD_SYSTEM_ERRORS: []const u8 = "cicd.system.errors";
...
pub const CICD_WORKER_COUNT: []const u8 = "cicd.worker.count";
...
pub const CONTAINER_CPU_TIME: []const u8 = "container.cpu.time";
...
/// |:-|:- |
/// | `cpu.mode` | `Conditionally_required`: Required if mode is available, i.e. metrics coming from the Docker Stats API. |
pub const CONTAINER_CPU_USAGE: []const u8 = "container.cpu.usage";
...
pub const CONTAINER_DISK_IO: []const u8 = "container.disk.io";
...
/// |:-|:-|:-|
/// | `counter` | `By` | `Development` |
pub const CONTAINER_MEMORY_USAGE: []const u8 = "container.memory.usage";
...
pub const CONTAINER_NETWORK_IO: []const u8 = "container.network.io";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const CONTAINER_UPTIME: []const u8 = "container.uptime";
...
pub const CPU_FREQUENCY: []const u8 = "cpu.frequency";
...
pub const CPU_TIME: []const u8 = "cpu.time";
...
pub const CPU_UTILIZATION: []const u8 = "cpu.utilization";
...
pub const CPYTHON_GC_COLLECTED_OBJECTS: []const u8 = "cpython.gc.collected_objects";
...
/// |:-|:- |
/// | `cpython.gc.generation` | `Required` |
pub const CPYTHON_GC_COLLECTIONS: []const u8 = "cpython.gc.collections";
...
/// |:-|:- |
/// | `cpython.gc.generation` | `Required` |
pub const CPYTHON_GC_UNCOLLECTABLE_OBJECTS: []const u8 = "cpython.gc.uncollectable_objects";
...
pub const DB_CLIENT_CONNECTION_COUNT: []const u8 = "db.client.connection.count";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_CREATE_TIME: []const u8 = "db.client.connection.create_time";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_IDLE_MAX: []const u8 = "db.client.connection.idle.max";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_IDLE_MIN: []const u8 = "db.client.connection.idle.min";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_MAX: []const u8 = "db.client.connection.max";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_PENDING_REQUESTS: []const u8 = "db.client.connection.pending_requests";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_TIMEOUTS: []const u8 = "db.client.connection.timeouts";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_USE_TIME: []const u8 = "db.client.connection.use_time";
...
/// |:-|:- |
/// | `db.client.connection.pool.name` | `Required` |
pub const DB_CLIENT_CONNECTION_WAIT_TIME: []const u8 = "db.client.connection.wait_time";
...
pub const DB_CLIENT_CONNECTIONS_CREATE_TIME: []const u8 = "db.client.connections.create_time";
...
pub const DB_CLIENT_CONNECTIONS_IDLE_MAX: []const u8 = "db.client.connections.idle.max";
...
pub const DB_CLIENT_CONNECTIONS_IDLE_MIN: []const u8 = "db.client.connections.idle.min";
...
pub const DB_CLIENT_CONNECTIONS_MAX: []const u8 = "db.client.connections.max";
...
pub const DB_CLIENT_CONNECTIONS_PENDING_REQUESTS: []const u8 = "db.client.connections.pending_requests";
...
pub const DB_CLIENT_CONNECTIONS_TIMEOUTS: []const u8 = "db.client.connections.timeouts";
...
pub const DB_CLIENT_CONNECTIONS_USAGE: []const u8 = "db.client.connections.usage";
...
pub const DB_CLIENT_CONNECTIONS_USE_TIME: []const u8 = "db.client.connections.use_time";
...
pub const DB_CLIENT_CONNECTIONS_WAIT_TIME: []const u8 = "db.client.connections.wait_time";
...
pub const DB_CLIENT_COSMOSDB_ACTIVE_INSTANCE_COUNT: []const u8 = "db.client.cosmosdb.active_instance.count";
...
pub const DB_CLIENT_COSMOSDB_OPERATION_REQUEST_CHARGE: []const u8 = "db.client.cosmosdb.operation.request_charge";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If using a port other than the default port for this DBMS and if `server.address` is set. |
pub const DB_CLIENT_OPERATION_DURATION: []const u8 = "db.client.operation.duration";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If using a port other than the default port for this DBMS and if `server.address` is set. |
pub const DB_CLIENT_RESPONSE_RETURNED_ROWS: []const u8 = "db.client.response.returned_rows";
...
pub const DNS_LOOKUP_DURATION: []const u8 = "dns.lookup.duration";
...
pub const DOTNET_ASSEMBLY_COUNT: []const u8 = "dotnet.assembly.count";
...
/// |:-|:- |
/// | `error.type` | `Required` |
pub const DOTNET_EXCEPTIONS: []const u8 = "dotnet.exceptions";
...
pub const DOTNET_GC_COLLECTIONS: []const u8 = "dotnet.gc.collections";
...
/// |:-|:-|:-|
/// | `counter` | `By` | `Stable` |
pub const DOTNET_GC_HEAP_TOTAL_ALLOCATED: []const u8 = "dotnet.gc.heap.total_allocated";
...
/// |:-|:- |
/// | `dotnet.gc.heap.generation` | `Required` |
pub const DOTNET_GC_LAST_COLLECTION_HEAP_FRAGMENTATION_SIZE: []const u8 = "dotnet.gc.last_collection.heap.fragmentation.size";
...
/// |:-|:- |
/// | `dotnet.gc.heap.generation` | `Required` |
pub const DOTNET_GC_LAST_COLLECTION_HEAP_SIZE: []const u8 = "dotnet.gc.last_collection.heap.size";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Stable` |
pub const DOTNET_GC_LAST_COLLECTION_MEMORY_COMMITTED_SIZE: []const u8 = "dotnet.gc.last_collection.memory.committed_size";
...
/// |:-|:-|:-|
/// | `counter` | `s` | `Stable` |
pub const DOTNET_GC_PAUSE_TIME: []const u8 = "dotnet.gc.pause.time";
...
/// |:-|:-|:-|
/// | `counter` | `s` | `Stable` |
pub const DOTNET_JIT_COMPILATION_TIME: []const u8 = "dotnet.jit.compilation.time";
...
/// |:-|:-|:-|
/// | `counter` | `By` | `Stable` |
pub const DOTNET_JIT_COMPILED_IL_SIZE: []const u8 = "dotnet.jit.compiled_il.size";
...
pub const DOTNET_JIT_COMPILED_METHODS: []const u8 = "dotnet.jit.compiled_methods";
...
pub const DOTNET_MONITOR_LOCK_CONTENTIONS: []const u8 = "dotnet.monitor.lock_contentions";
...
pub const DOTNET_PROCESS_CPU_COUNT: []const u8 = "dotnet.process.cpu.count";
...
/// |:-|:- |
/// | `cpu.mode` | `Required` |
pub const DOTNET_PROCESS_CPU_TIME: []const u8 = "dotnet.process.cpu.time";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Stable` |
pub const DOTNET_PROCESS_MEMORY_WORKING_SET: []const u8 = "dotnet.process.memory.working_set";
...
pub const DOTNET_THREAD_POOL_QUEUE_LENGTH: []const u8 = "dotnet.thread_pool.queue.length";
...
pub const DOTNET_THREAD_POOL_THREAD_COUNT: []const u8 = "dotnet.thread_pool.thread.count";
...
pub const DOTNET_THREAD_POOL_WORK_ITEM_COUNT: []const u8 = "dotnet.thread_pool.work_item.count";
...
pub const DOTNET_TIMER_COUNT: []const u8 = "dotnet.timer.count";
...
pub const FAAS_COLDSTARTS: []const u8 = "faas.coldstarts";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_CPU_USAGE: []const u8 = "faas.cpu_usage";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_ERRORS: []const u8 = "faas.errors";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_INIT_DURATION: []const u8 = "faas.init_duration";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_INVOCATIONS: []const u8 = "faas.invocations";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_INVOKE_DURATION: []const u8 = "faas.invoke_duration";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_MEM_USAGE: []const u8 = "faas.mem_usage";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_NET_IO: []const u8 = "faas.net_io";
...
/// |:-|:- |
/// | `faas.trigger` | `Recommended` |
pub const FAAS_TIMEOUTS: []const u8 = "faas.timeouts";
...
pub const GEN_AI_CLIENT_OPERATION_DURATION: []const u8 = "gen_ai.client.operation.duration";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If `server.address` is set. |
pub const GEN_AI_CLIENT_TOKEN_USAGE: []const u8 = "gen_ai.client.token.usage";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If `server.address` is set. |
pub const GEN_AI_SERVER_REQUEST_DURATION: []const u8 = "gen_ai.server.request.duration";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If `server.address` is set. |
pub const GEN_AI_SERVER_TIME_PER_OUTPUT_TOKEN: []const u8 = "gen_ai.server.time_per_output_token";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Conditionally_required`: If `server.address` is set. |
pub const GEN_AI_SERVER_TIME_TO_FIRST_TOKEN: []const u8 = "gen_ai.server.time_to_first_token";
...
pub const GO_CONFIG_GOGC: []const u8 = "go.config.gogc";
...
pub const GO_GOROUTINE_COUNT: []const u8 = "go.goroutine.count";
...
/// |:-|:-|:-|
/// | `counter` | `By` | `Development` |
pub const GO_MEMORY_ALLOCATED: []const u8 = "go.memory.allocated";
...
pub const GO_MEMORY_ALLOCATIONS: []const u8 = "go.memory.allocations";
...
pub const GO_MEMORY_GC_GOAL: []const u8 = "go.memory.gc.goal";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const GO_MEMORY_LIMIT: []const u8 = "go.memory.limit";
...
pub const GO_MEMORY_USED: []const u8 = "go.memory.used";
...
pub const GO_PROCESSOR_LIMIT: []const u8 = "go.processor.limit";
...
/// |:-|:-|:-|
/// | `histogram` | `s` | `Development` |
pub const GO_SCHEDULE_DURATION: []const u8 = "go.schedule.duration";
...
pub const HTTP_CLIENT_ACTIVE_REQUESTS: []const u8 = "http.client.active_requests";
...
/// | `server.port` | `Required` |
/// | `url.scheme` | `Opt_in` |
pub const HTTP_CLIENT_CONNECTION_DURATION: []const u8 = "http.client.connection.duration";
...
/// | `server.port` | `Required` |
/// | `url.scheme` | `Opt_in` |
pub const HTTP_CLIENT_OPEN_CONNECTIONS: []const u8 = "http.client.open_connections";
...
/// | `url.scheme` | `Opt_in` |
/// | `url.template` | `Conditionally_required`: If available. |
pub const HTTP_CLIENT_REQUEST_BODY_SIZE: []const u8 = "http.client.request.body.size";
...
/// | `url.scheme` | `Opt_in` |
/// | `url.template` | `Opt_in` |
pub const HTTP_CLIENT_REQUEST_DURATION: []const u8 = "http.client.request.duration";
...
/// | `url.scheme` | `Opt_in` |
/// | `url.template` | `Conditionally_required`: If available. |
pub const HTTP_CLIENT_RESPONSE_BODY_SIZE: []const u8 = "http.client.response.body.size";
...
/// | `server.port` | `Opt_in` |
/// | `url.scheme` | `Required` |
pub const HTTP_SERVER_ACTIVE_REQUESTS: []const u8 = "http.server.active_requests";
...
pub const HTTP_SERVER_REQUEST_BODY_SIZE: []const u8 = "http.server.request.body.size";
...
/// | `url.scheme` | `Required` |
/// | `user_agent.synthetic.type` | `Opt_in` |
pub const HTTP_SERVER_REQUEST_DURATION: []const u8 = "http.server.request.duration";
...
/// | `url.scheme` | `Required` |
/// | `user_agent.synthetic.type` | `Opt_in` |
pub const HTTP_SERVER_RESPONSE_BODY_SIZE: []const u8 = "http.server.response.body.size";
...
/// | `hw.type` | `Required` |
pub const HW_ENERGY: []const u8 = "hw.energy";
...
/// | `hw.parent` | `Recommended` |
/// | `hw.type` | `Required` |
pub const HW_ERRORS: []const u8 = "hw.errors";
...
/// | `hw.name` | `Recommended` |
/// | `hw.parent` | `Recommended` |
pub const HW_HOST_AMBIENT_TEMPERATURE: []const u8 = "hw.host.ambient_temperature";
...
/// | `hw.name` | `Recommended` |
/// | `hw.parent` | `Recommended` |
pub const HW_HOST_ENERGY: []const u8 = "hw.host.energy";
...
/// | `hw.name` | `Recommended` |
/// | `hw.parent` | `Recommended` |
pub const HW_HOST_HEATING_MARGIN: []const u8 = "hw.host.heating_margin";
...
/// | `hw.name` | `Recommended` |
/// | `hw.parent` | `Recommended` |
pub const HW_HOST_POWER: []const u8 = "hw.host.power";
...
/// | `hw.parent` | `Recommended` |
/// | `hw.type` | `Required` |
pub const HW_POWER: []const u8 = "hw.power";
...
/// | `hw.state` | `Required` |
/// | `hw.type` | `Required` |
pub const HW_STATUS: []const u8 = "hw.status";
...
pub const JVM_BUFFER_COUNT: []const u8 = "jvm.buffer.count";
...
/// |:-|:- |
/// | `jvm.buffer.pool.name` | `Recommended` |
pub const JVM_BUFFER_MEMORY_LIMIT: []const u8 = "jvm.buffer.memory.limit";
...
pub const JVM_BUFFER_MEMORY_USAGE: []const u8 = "jvm.buffer.memory.usage";
...
/// |:-|:- |
/// | `jvm.buffer.pool.name` | `Recommended` |
pub const JVM_BUFFER_MEMORY_USED: []const u8 = "jvm.buffer.memory.used";
...
pub const JVM_CLASS_COUNT: []const u8 = "jvm.class.count";
...
pub const JVM_CLASS_LOADED: []const u8 = "jvm.class.loaded";
...
/// |:-|:-|:-|
/// | `counter` | `{class}` | `Stable` |
pub const JVM_CLASS_UNLOADED: []const u8 = "jvm.class.unloaded";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Stable` |
pub const JVM_CPU_COUNT: []const u8 = "jvm.cpu.count";
...
/// |:-|:-|:-|
/// | `gauge` | `1` | `Stable` |
pub const JVM_CPU_RECENT_UTILIZATION: []const u8 = "jvm.cpu.recent_utilization";
...
/// |:-|:-|:-|
/// | `counter` | `s` | `Stable` |
pub const JVM_CPU_TIME: []const u8 = "jvm.cpu.time";
...
pub const JVM_FILE_DESCRIPTOR_COUNT: []const u8 = "jvm.file_descriptor.count";
...
pub const JVM_GC_DURATION: []const u8 = "jvm.gc.duration";
...
pub const JVM_MEMORY_COMMITTED: []const u8 = "jvm.memory.committed";
...
/// | `jvm.memory.pool.name` | `Recommended` |
/// | `jvm.memory.type` | `Recommended` |
pub const JVM_MEMORY_INIT: []const u8 = "jvm.memory.init";
...
/// | `jvm.memory.pool.name` | `Recommended` |
/// | `jvm.memory.type` | `Recommended` |
pub const JVM_MEMORY_LIMIT: []const u8 = "jvm.memory.limit";
...
/// | `jvm.memory.pool.name` | `Recommended` |
/// | `jvm.memory.type` | `Recommended` |
pub const JVM_MEMORY_USED: []const u8 = "jvm.memory.used";
...
/// | `jvm.memory.pool.name` | `Recommended` |
/// | `jvm.memory.type` | `Recommended` |
pub const JVM_MEMORY_USED_AFTER_LAST_GC: []const u8 = "jvm.memory.used_after_last_gc";
...
pub const JVM_SYSTEM_CPU_LOAD_1M: []const u8 = "jvm.system.cpu.load_1m";
...
/// |:-|:-|:-|
/// | `gauge` | `1` | `Development` |
pub const JVM_SYSTEM_CPU_UTILIZATION: []const u8 = "jvm.system.cpu.utilization";
...
pub const JVM_THREAD_COUNT: []const u8 = "jvm.thread.count";
...
pub const K8S_CONTAINER_CPU_LIMIT: []const u8 = "k8s.container.cpu.limit";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_CONTAINER_CPU_REQUEST: []const u8 = "k8s.container.cpu.request";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_EPHEMERAL_STORAGE_LIMIT: []const u8 = "k8s.container.ephemeral_storage.limit";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_EPHEMERAL_STORAGE_REQUEST: []const u8 = "k8s.container.ephemeral_storage.request";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_MEMORY_LIMIT: []const u8 = "k8s.container.memory.limit";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_MEMORY_REQUEST: []const u8 = "k8s.container.memory.request";
...
pub const K8S_CONTAINER_READY: []const u8 = "k8s.container.ready";
...
pub const K8S_CONTAINER_RESTART_COUNT: []const u8 = "k8s.container.restart.count";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_STORAGE_LIMIT: []const u8 = "k8s.container.storage.limit";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_CONTAINER_STORAGE_REQUEST: []const u8 = "k8s.container.storage.request";
...
pub const K8S_CRONJOB_ACTIVE_JOBS: []const u8 = "k8s.cronjob.active_jobs";
...
pub const K8S_DAEMONSET_CURRENT_SCHEDULED_NODES: []const u8 = "k8s.daemonset.current_scheduled_nodes";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{node}` | `Development` |
pub const K8S_DAEMONSET_DESIRED_SCHEDULED_NODES: []const u8 = "k8s.daemonset.desired_scheduled_nodes";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{node}` | `Development` |
pub const K8S_DAEMONSET_MISSCHEDULED_NODES: []const u8 = "k8s.daemonset.misscheduled_nodes";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{node}` | `Development` |
pub const K8S_DAEMONSET_READY_NODES: []const u8 = "k8s.daemonset.ready_nodes";
...
pub const K8S_DEPLOYMENT_AVAILABLE_PODS: []const u8 = "k8s.deployment.available_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_DEPLOYMENT_DESIRED_PODS: []const u8 = "k8s.deployment.desired_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_HPA_CURRENT_PODS: []const u8 = "k8s.hpa.current_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_HPA_DESIRED_PODS: []const u8 = "k8s.hpa.desired_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_HPA_MAX_PODS: []const u8 = "k8s.hpa.max_pods";
...
pub const K8S_HPA_METRIC_TARGET_CPU_AVERAGE_UTILIZATION: []const u8 = "k8s.hpa.metric.target.cpu.average_utilization";
...
/// | `k8s.container.name` | `Conditionally_required`: if and only if k8s.hpa.metric.type is ContainerResource |
/// | `k8s.hpa.metric.type` | `Recommended` |
pub const K8S_HPA_METRIC_TARGET_CPU_AVERAGE_VALUE: []const u8 = "k8s.hpa.metric.target.cpu.average_value";
...
/// | `k8s.container.name` | `Conditionally_required`: if and only if k8s.hpa.metric.type is ContainerResource |
/// | `k8s.hpa.metric.type` | `Recommended` |
pub const K8S_HPA_METRIC_TARGET_CPU_VALUE: []const u8 = "k8s.hpa.metric.target.cpu.value";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_HPA_MIN_PODS: []const u8 = "k8s.hpa.min_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_JOB_ACTIVE_PODS: []const u8 = "k8s.job.active_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_JOB_DESIRED_SUCCESSFUL_PODS: []const u8 = "k8s.job.desired_successful_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_JOB_FAILED_PODS: []const u8 = "k8s.job.failed_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_JOB_MAX_PARALLEL_PODS: []const u8 = "k8s.job.max_parallel_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_JOB_SUCCESSFUL_PODS: []const u8 = "k8s.job.successful_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_NODE_ALLOCATABLE_CPU: []const u8 = "k8s.node.allocatable.cpu";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_NODE_ALLOCATABLE_EPHEMERAL_STORAGE: []const u8 = "k8s.node.allocatable.ephemeral_storage";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_NODE_ALLOCATABLE_MEMORY: []const u8 = "k8s.node.allocatable.memory";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_NODE_ALLOCATABLE_PODS: []const u8 = "k8s.node.allocatable.pods";
...
/// |:-|:-|:-|
/// | `counter` | `s` | `Development` |
pub const K8S_NODE_CPU_TIME: []const u8 = "k8s.node.cpu.time";
...
/// |:-|:-|:-|
/// | `gauge` | `{cpu}` | `Development` |
pub const K8S_NODE_CPU_USAGE: []const u8 = "k8s.node.cpu.usage";
...
pub const K8S_NODE_MEMORY_USAGE: []const u8 = "k8s.node.memory.usage";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const K8S_NODE_NETWORK_ERRORS: []const u8 = "k8s.node.network.errors";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const K8S_NODE_NETWORK_IO: []const u8 = "k8s.node.network.io";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const K8S_NODE_UPTIME: []const u8 = "k8s.node.uptime";
...
/// |:-|:-|:-|
/// | `counter` | `s` | `Development` |
pub const K8S_POD_CPU_TIME: []const u8 = "k8s.pod.cpu.time";
...
/// |:-|:-|:-|
/// | `gauge` | `{cpu}` | `Development` |
pub const K8S_POD_CPU_USAGE: []const u8 = "k8s.pod.cpu.usage";
...
/// |:-|:-|:-|
/// | `gauge` | `By` | `Development` |
pub const K8S_POD_MEMORY_USAGE: []const u8 = "k8s.pod.memory.usage";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const K8S_POD_NETWORK_ERRORS: []const u8 = "k8s.pod.network.errors";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const K8S_POD_NETWORK_IO: []const u8 = "k8s.pod.network.io";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const K8S_POD_UPTIME: []const u8 = "k8s.pod.uptime";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_REPLICASET_AVAILABLE_PODS: []const u8 = "k8s.replicaset.available_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_REPLICASET_DESIRED_PODS: []const u8 = "k8s.replicaset.desired_pods";
...
pub const K8S_REPLICATION_CONTROLLER_AVAILABLE_PODS: []const u8 = "k8s.replication_controller.available_pods";
...
pub const K8S_REPLICATION_CONTROLLER_DESIRED_PODS: []const u8 = "k8s.replication_controller.desired_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_REPLICATIONCONTROLLER_AVAILABLE_PODS: []const u8 = "k8s.replicationcontroller.available_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_REPLICATIONCONTROLLER_DESIRED_PODS: []const u8 = "k8s.replicationcontroller.desired_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_RESOURCEQUOTA_CPU_LIMIT_HARD: []const u8 = "k8s.resourcequota.cpu.limit.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_RESOURCEQUOTA_CPU_LIMIT_USED: []const u8 = "k8s.resourcequota.cpu.limit.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_RESOURCEQUOTA_CPU_REQUEST_HARD: []const u8 = "k8s.resourcequota.cpu.request.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const K8S_RESOURCEQUOTA_CPU_REQUEST_USED: []const u8 = "k8s.resourcequota.cpu.request.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_EPHEMERAL_STORAGE_LIMIT_HARD: []const u8 = "k8s.resourcequota.ephemeral_storage.limit.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_EPHEMERAL_STORAGE_LIMIT_USED: []const u8 = "k8s.resourcequota.ephemeral_storage.limit.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_EPHEMERAL_STORAGE_REQUEST_HARD: []const u8 = "k8s.resourcequota.ephemeral_storage.request.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_EPHEMERAL_STORAGE_REQUEST_USED: []const u8 = "k8s.resourcequota.ephemeral_storage.request.used";
...
pub const K8S_RESOURCEQUOTA_HUGEPAGE_COUNT_REQUEST_HARD: []const u8 = "k8s.resourcequota.hugepage_count.request.hard";
...
/// |:-|:- |
/// | `k8s.hugepage.size` | `Required` |
pub const K8S_RESOURCEQUOTA_HUGEPAGE_COUNT_REQUEST_USED: []const u8 = "k8s.resourcequota.hugepage_count.request.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_MEMORY_LIMIT_HARD: []const u8 = "k8s.resourcequota.memory.limit.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_MEMORY_LIMIT_USED: []const u8 = "k8s.resourcequota.memory.limit.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_MEMORY_REQUEST_HARD: []const u8 = "k8s.resourcequota.memory.request.hard";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const K8S_RESOURCEQUOTA_MEMORY_REQUEST_USED: []const u8 = "k8s.resourcequota.memory.request.used";
...
pub const K8S_RESOURCEQUOTA_OBJECT_COUNT_HARD: []const u8 = "k8s.resourcequota.object_count.hard";
...
/// |:-|:- |
/// | `k8s.resourcequota.resource_name` | `Required` |
pub const K8S_RESOURCEQUOTA_OBJECT_COUNT_USED: []const u8 = "k8s.resourcequota.object_count.used";
...
pub const K8S_RESOURCEQUOTA_PERSISTENTVOLUMECLAIM_COUNT_HARD: []const u8 = "k8s.resourcequota.persistentvolumeclaim_count.hard";
...
/// |:-|:- |
/// | `k8s.storageclass.name` | `Conditionally_required`: The `k8s.storageclass.name` should be required when a resource quota is defined for a specific storage class.  |
pub const K8S_RESOURCEQUOTA_PERSISTENTVOLUMECLAIM_COUNT_USED: []const u8 = "k8s.resourcequota.persistentvolumeclaim_count.used";
...
/// |:-|:- |
/// | `k8s.storageclass.name` | `Conditionally_required`: The `k8s.storageclass.name` should be required when a resource quota is defined for a specific storage class.  |
pub const K8S_RESOURCEQUOTA_STORAGE_REQUEST_HARD: []const u8 = "k8s.resourcequota.storage.request.hard";
...
/// |:-|:- |
/// | `k8s.storageclass.name` | `Conditionally_required`: The `k8s.storageclass.name` should be required when a resource quota is defined for a specific storage class.  |
pub const K8S_RESOURCEQUOTA_STORAGE_REQUEST_USED: []const u8 = "k8s.resourcequota.storage.request.used";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_STATEFULSET_CURRENT_PODS: []const u8 = "k8s.statefulset.current_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_STATEFULSET_DESIRED_PODS: []const u8 = "k8s.statefulset.desired_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_STATEFULSET_READY_PODS: []const u8 = "k8s.statefulset.ready_pods";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{pod}` | `Development` |
pub const K8S_STATEFULSET_UPDATED_PODS: []const u8 = "k8s.statefulset.updated_pods";
...
pub const KESTREL_ACTIVE_CONNECTIONS: []const u8 = "kestrel.active_connections";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Recommended` |
pub const KESTREL_ACTIVE_TLS_HANDSHAKES: []const u8 = "kestrel.active_tls_handshakes";
...
pub const KESTREL_CONNECTION_DURATION: []const u8 = "kestrel.connection.duration";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Recommended` |
pub const KESTREL_QUEUED_CONNECTIONS: []const u8 = "kestrel.queued_connections";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Recommended` |
pub const KESTREL_QUEUED_REQUESTS: []const u8 = "kestrel.queued_requests";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Recommended` |
pub const KESTREL_REJECTED_CONNECTIONS: []const u8 = "kestrel.rejected_connections";
...
/// | `server.port` | `Recommended` |
/// | `tls.protocol.version` | `Recommended` |
pub const KESTREL_TLS_HANDSHAKE_DURATION: []const u8 = "kestrel.tls_handshake.duration";
...
/// | `server.address` | `Recommended` |
/// | `server.port` | `Recommended` |
pub const KESTREL_UPGRADED_CONNECTIONS: []const u8 = "kestrel.upgraded_connections";
...
/// | `server.port` | `Recommended` |
pub const MESSAGING_CLIENT_CONSUMED_MESSAGES: []const u8 = "messaging.client.consumed.messages";
...
/// | `server.address` | `Conditionally_required`: If available. |
/// | `server.port` | `Recommended` |
pub const MESSAGING_CLIENT_OPERATION_DURATION: []const u8 = "messaging.client.operation.duration";
...
pub const MESSAGING_CLIENT_PUBLISHED_MESSAGES: []const u8 = "messaging.client.published.messages";
...
/// | `server.address` | `Conditionally_required`: If available. |
/// | `server.port` | `Recommended` |
pub const MESSAGING_CLIENT_SENT_MESSAGES: []const u8 = "messaging.client.sent.messages";
...
/// | `server.address` | `Conditionally_required`: If available. |
/// | `server.port` | `Recommended` |
pub const MESSAGING_PROCESS_DURATION: []const u8 = "messaging.process.duration";
...
pub const MESSAGING_PROCESS_MESSAGES: []const u8 = "messaging.process.messages";
...
pub const MESSAGING_PUBLISH_DURATION: []const u8 = "messaging.publish.duration";
...
/// 
/// Note: This metric is deprecated. Replaced by `messaging.client.sent.messages`.
pub const MESSAGING_PUBLISH_MESSAGES: []const u8 = "messaging.publish.messages";
...
/// 
/// Note: This metric is deprecated. Replaced by `messaging.client.operation.duration`.
pub const MESSAGING_RECEIVE_DURATION: []const u8 = "messaging.receive.duration";
...
/// 
/// Note: This metric is deprecated. Replaced by `messaging.client.consumed.messages`.
pub const MESSAGING_RECEIVE_MESSAGES: []const u8 = "messaging.receive.messages";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_MAX: []const u8 = "nodejs.eventloop.delay.max";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_MEAN: []const u8 = "nodejs.eventloop.delay.mean";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_MIN: []const u8 = "nodejs.eventloop.delay.min";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_P50: []const u8 = "nodejs.eventloop.delay.p50";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_P90: []const u8 = "nodejs.eventloop.delay.p90";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_P99: []const u8 = "nodejs.eventloop.delay.p99";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const NODEJS_EVENTLOOP_DELAY_STDDEV: []const u8 = "nodejs.eventloop.delay.stddev";
...
pub const NODEJS_EVENTLOOP_TIME: []const u8 = "nodejs.eventloop.time";
...
/// |:-|:-|:-|
/// | `gauge` | `1` | `Development` |
pub const NODEJS_EVENTLOOP_UTILIZATION: []const u8 = "nodejs.eventloop.utilization";
...
pub const OTEL_SDK_EXPORTER_LOG_EXPORTED: []const u8 = "otel.sdk.exporter.log.exported";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_LOG_INFLIGHT: []const u8 = "otel.sdk.exporter.log.inflight";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_METRIC_DATA_POINT_EXPORTED: []const u8 = "otel.sdk.exporter.metric_data_point.exported";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_METRIC_DATA_POINT_INFLIGHT: []const u8 = "otel.sdk.exporter.metric_data_point.inflight";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_OPERATION_DURATION: []const u8 = "otel.sdk.exporter.operation.duration";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_SPAN_EXPORTED: []const u8 = "otel.sdk.exporter.span.exported";
...
pub const OTEL_SDK_EXPORTER_SPAN_EXPORTED_COUNT: []const u8 = "otel.sdk.exporter.span.exported.count";
...
/// | `server.address` | `{"recommended": "when applicable"}` |
/// | `server.port` | `{"recommended": "when applicable"}` |
pub const OTEL_SDK_EXPORTER_SPAN_INFLIGHT: []const u8 = "otel.sdk.exporter.span.inflight";
...
pub const OTEL_SDK_EXPORTER_SPAN_INFLIGHT_COUNT: []const u8 = "otel.sdk.exporter.span.inflight.count";
...
/// |:-|:-|:-|
/// | `counter` | `{log_record}` | `Development` |
pub const OTEL_SDK_LOG_CREATED: []const u8 = "otel.sdk.log.created";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_METRIC_READER_COLLECTION_DURATION: []const u8 = "otel.sdk.metric_reader.collection.duration";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_LOG_PROCESSED: []const u8 = "otel.sdk.processor.log.processed";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_LOG_QUEUE_CAPACITY: []const u8 = "otel.sdk.processor.log.queue.capacity";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_LOG_QUEUE_SIZE: []const u8 = "otel.sdk.processor.log.queue.size";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_SPAN_PROCESSED: []const u8 = "otel.sdk.processor.span.processed";
...
pub const OTEL_SDK_PROCESSOR_SPAN_PROCESSED_COUNT: []const u8 = "otel.sdk.processor.span.processed.count";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_SPAN_QUEUE_CAPACITY: []const u8 = "otel.sdk.processor.span.queue.capacity";
...
/// | `otel.component.name` | `Recommended` |
/// | `otel.component.type` | `Recommended` |
pub const OTEL_SDK_PROCESSOR_SPAN_QUEUE_SIZE: []const u8 = "otel.sdk.processor.span.queue.size";
...
pub const OTEL_SDK_SPAN_ENDED: []const u8 = "otel.sdk.span.ended";
...
/// 
/// Note: This metric is deprecated. Obsoleted.
pub const OTEL_SDK_SPAN_ENDED_COUNT: []const u8 = "otel.sdk.span.ended.count";
...
pub const OTEL_SDK_SPAN_LIVE: []const u8 = "otel.sdk.span.live";
...
pub const OTEL_SDK_SPAN_LIVE_COUNT: []const u8 = "otel.sdk.span.live.count";
...
/// | `otel.span.sampling_result` | `Recommended` |
pub const OTEL_SDK_SPAN_STARTED: []const u8 = "otel.sdk.span.started";
...
pub const PROCESS_CONTEXT_SWITCHES: []const u8 = "process.context_switches";
...
/// |:-|:- |
/// | `cpu.mode` | `Recommended` |
pub const PROCESS_CPU_TIME: []const u8 = "process.cpu.time";
...
/// |:-|:- |
/// | `cpu.mode` | `Recommended` |
pub const PROCESS_CPU_UTILIZATION: []const u8 = "process.cpu.utilization";
...
/// |:-|:- |
/// | `disk.io.direction` | `Recommended` |
pub const PROCESS_DISK_IO: []const u8 = "process.disk.io";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const PROCESS_MEMORY_USAGE: []const u8 = "process.memory.usage";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const PROCESS_MEMORY_VIRTUAL: []const u8 = "process.memory.virtual";
...
/// |:-|:- |
/// | `network.io.direction` | `Recommended` |
pub const PROCESS_NETWORK_IO: []const u8 = "process.network.io";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{file_descriptor}` | `Development` |
pub const PROCESS_OPEN_FILE_DESCRIPTOR_COUNT: []const u8 = "process.open_file_descriptor.count";
...
pub const PROCESS_PAGING_FAULTS: []const u8 = "process.paging.faults";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{thread}` | `Development` |
pub const PROCESS_THREAD_COUNT: []const u8 = "process.thread.count";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const PROCESS_UPTIME: []const u8 = "process.uptime";
...
/// |:-|:-|:-|
/// | `histogram` | `ms` | `Development` |
pub const RPC_CLIENT_DURATION: []const u8 = "rpc.client.duration";
...
/// |:-|:-|:-|
/// | `histogram` | `By` | `Development` |
pub const RPC_CLIENT_REQUEST_SIZE: []const u8 = "rpc.client.request.size";
...
pub const RPC_CLIENT_REQUESTS_PER_RPC: []const u8 = "rpc.client.requests_per_rpc";
...
/// |:-|:-|:-|
/// | `histogram` | `By` | `Development` |
pub const RPC_CLIENT_RESPONSE_SIZE: []const u8 = "rpc.client.response.size";
...
/// |:-|:-|:-|
/// | `histogram` | `{count}` | `Development` |
pub const RPC_CLIENT_RESPONSES_PER_RPC: []const u8 = "rpc.client.responses_per_rpc";
...
/// |:-|:-|:-|
/// | `histogram` | `ms` | `Development` |
pub const RPC_SERVER_DURATION: []const u8 = "rpc.server.duration";
...
/// |:-|:-|:-|
/// | `histogram` | `By` | `Development` |
pub const RPC_SERVER_REQUEST_SIZE: []const u8 = "rpc.server.request.size";
...
/// |:-|:-|:-|
/// | `histogram` | `{count}` | `Development` |
pub const RPC_SERVER_REQUESTS_PER_RPC: []const u8 = "rpc.server.requests_per_rpc";
...
/// |:-|:-|:-|
/// | `histogram` | `By` | `Development` |
pub const RPC_SERVER_RESPONSE_SIZE: []const u8 = "rpc.server.response.size";
...
/// |:-|:-|:-|
/// | `histogram` | `{count}` | `Development` |
pub const RPC_SERVER_RESPONSES_PER_RPC: []const u8 = "rpc.server.responses_per_rpc";
...
pub const SIGNALR_SERVER_ACTIVE_CONNECTIONS: []const u8 = "signalr.server.active_connections";
...
/// | `signalr.connection.status` | `Recommended` |
/// | `signalr.transport` | `Recommended` |
pub const SIGNALR_SERVER_CONNECTION_DURATION: []const u8 = "signalr.server.connection.duration";
...
/// |:-|:- |
/// | `cpu.logical_number` | `Recommended` |
pub const SYSTEM_CPU_FREQUENCY: []const u8 = "system.cpu.frequency";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const SYSTEM_CPU_LOGICAL_COUNT: []const u8 = "system.cpu.logical.count";
...
/// |:-|:-|:-|
/// | `updowncounter` | `{cpu}` | `Development` |
pub const SYSTEM_CPU_PHYSICAL_COUNT: []const u8 = "system.cpu.physical.count";
...
/// | `cpu.logical_number` | `Recommended` |
/// | `cpu.mode` | `Recommended` |
pub const SYSTEM_CPU_TIME: []const u8 = "system.cpu.time";
...
/// | `cpu.logical_number` | `Recommended` |
/// | `cpu.mode` | `Recommended` |
pub const SYSTEM_CPU_UTILIZATION: []const u8 = "system.cpu.utilization";
...
/// | `disk.io.direction` | `Recommended` |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_IO: []const u8 = "system.disk.io";
...
/// |:-|:- |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_IO_TIME: []const u8 = "system.disk.io_time";
...
/// |:-|:- |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_LIMIT: []const u8 = "system.disk.limit";
...
/// | `disk.io.direction` | `Recommended` |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_MERGED: []const u8 = "system.disk.merged";
...
/// | `disk.io.direction` | `Recommended` |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_OPERATION_TIME: []const u8 = "system.disk.operation_time";
...
/// | `disk.io.direction` | `Recommended` |
/// | `system.device` | `Recommended` |
pub const SYSTEM_DISK_OPERATIONS: []const u8 = "system.disk.operations";
...
pub const SYSTEM_FILESYSTEM_LIMIT: []const u8 = "system.filesystem.limit";
...
/// | `system.filesystem.type` | `Recommended` |
pub const SYSTEM_FILESYSTEM_USAGE: []const u8 = "system.filesystem.usage";
...
/// | `system.filesystem.state` | `Recommended` |
/// | `system.filesystem.type` | `Recommended` |
pub const SYSTEM_FILESYSTEM_UTILIZATION: []const u8 = "system.filesystem.utilization";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const SYSTEM_LINUX_MEMORY_AVAILABLE: []const u8 = "system.linux.memory.available";
...
pub const SYSTEM_LINUX_MEMORY_SLAB_USAGE: []const u8 = "system.linux.memory.slab.usage";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const SYSTEM_MEMORY_LIMIT: []const u8 = "system.memory.limit";
...
/// |:-|:-|:-|
/// | `updowncounter` | `By` | `Development` |
pub const SYSTEM_MEMORY_SHARED: []const u8 = "system.memory.shared";
...
pub const SYSTEM_MEMORY_USAGE: []const u8 = "system.memory.usage";
...
/// |:-|:- |
/// | `system.memory.state` | `Recommended` |
pub const SYSTEM_MEMORY_UTILIZATION: []const u8 = "system.memory.utilization";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.transport` | `Recommended` |
pub const SYSTEM_NETWORK_CONNECTION_COUNT: []const u8 = "system.network.connection.count";
...
pub const SYSTEM_NETWORK_CONNECTIONS: []const u8 = "system.network.connections";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const SYSTEM_NETWORK_DROPPED: []const u8 = "system.network.dropped";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const SYSTEM_NETWORK_ERRORS: []const u8 = "system.network.errors";
...
/// | `network.interface.name` | `Recommended` |
/// | `network.io.direction` | `Recommended` |
pub const SYSTEM_NETWORK_IO: []const u8 = "system.network.io";
...
/// | `network.io.direction` | `Recommended` |
/// | `system.device` | `Recommended` |
pub const SYSTEM_NETWORK_PACKETS: []const u8 = "system.network.packets";
...
pub const SYSTEM_PAGING_FAULTS: []const u8 = "system.paging.faults";
...
/// | `system.paging.type` | `Recommended` |
pub const SYSTEM_PAGING_OPERATIONS: []const u8 = "system.paging.operations";
...
pub const SYSTEM_PAGING_USAGE: []const u8 = "system.paging.usage";
...
/// | `system.device` | `Recommended` |
/// | `system.paging.state` | `Recommended` |
pub const SYSTEM_PAGING_UTILIZATION: []const u8 = "system.paging.utilization";
...
pub const SYSTEM_PROCESS_COUNT: []const u8 = "system.process.count";
...
pub const SYSTEM_PROCESS_CREATED: []const u8 = "system.process.created";
...
/// |:-|:-|:-|
/// | `gauge` | `s` | `Development` |
pub const SYSTEM_UPTIME: []const u8 = "system.uptime";
...
pub const V8JS_GC_DURATION: []const u8 = "v8js.gc.duration";
...
pub const V8JS_HEAP_SPACE_AVAILABLE_SIZE: []const u8 = "v8js.heap.space.available_size";
...
/// |:-|:- |
/// | `v8js.heap.space.name` | `Required` |
pub const V8JS_HEAP_SPACE_PHYSICAL_SIZE: []const u8 = "v8js.heap.space.physical_size";
...
/// |:-|:- |
/// | `v8js.heap.space.name` | `Required` |
pub const V8JS_MEMORY_HEAP_LIMIT: []const u8 = "v8js.memory.heap.limit";
...
/// |:-|:- |
/// | `v8js.heap.space.name` | `Required` |
pub const V8JS_MEMORY_HEAP_USED: []const u8 = "v8js.memory.heap.used";
...
pub const VCS_CHANGE_COUNT: []const u8 = "vcs.change.count";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_CHANGE_DURATION: []const u8 = "vcs.change.duration";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_CHANGE_TIME_TO_APPROVAL: []const u8 = "vcs.change.time_to_approval";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_CHANGE_TIME_TO_MERGE: []const u8 = "vcs.change.time_to_merge";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_CONTRIBUTOR_COUNT: []const u8 = "vcs.contributor.count";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_REF_COUNT: []const u8 = "vcs.ref.count";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_REF_LINES_DELTA: []const u8 = "vcs.ref.lines_delta";
...
pub const VCS_REF_REVISIONS_DELTA: []const u8 = "vcs.ref.revisions_delta";
...
/// | `vcs.repository.name` | `Recommended` |
/// | `vcs.repository.url.full` | `Required` |
pub const VCS_REF_TIME: []const u8 = "vcs.ref.time";
...
/// | `vcs.owner.name` | `Recommended` |
/// | `vcs.provider.name` | `Opt_in` |
pub const VCS_REPOSITORY_COUNT: []const u8 = "vcs.repository.count";
